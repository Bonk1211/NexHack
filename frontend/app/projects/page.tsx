  ...
  return (
    <div className="px-10 py-10">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="font-display text-[32px] text-primary">Projects</h1>
        ...
        <button
          ...
          className="rounded-xl bg-accent px-5 py-2.5 text-[14px] font-medium text-white transition-opacity hover:opacity-90"
        >
          New project
        </button>
      </div>
